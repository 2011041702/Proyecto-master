...
import com.example.chris.myapplication.Conexion.Conexion;
import com.example.chris.myapplication.Controlador.CardAdapter;
import com.example.chris.myapplication.Modelo.SuperHero;
...
public class MainActivity extends AppCompatActivity implements RecyclerView.OnScrollChangeListener  {
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Conexion.DATA_URL + String.valueOf(requestCount),
